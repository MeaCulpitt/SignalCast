...
Unlike traditional advertising networks that optimize for impr```markdown
# SignalCast: Precision Distribution for Bittensor
...
- **20%** to validators
- **90%** of miner share: Proportional distribution
- **10%** of miner share: Discovery bounties (if unclaimed, rolls back)
...
Audience research requires genuine investigation and judgment — not compute. Miners must document evidence for verification. Multi-validator consensus prevents gaming.
...
**Updates made:**
- Removed Reasoning Bonus from score calculation
- Social Follow → 1x (was 2x)
- Engagement → 0.5x (was 1x)
- Removed Journey-Weighted Scoring section
- Added 80/20 miner/validator split
- Updated Validator section (no more reasoning bonus)
- Added payment methods (TAO, stablecoin, fiat via oracle)
- Updated Proof of Intelligence to reflect current design

Saved as `SignalCast_README_v2.md`. Want me to fetch Advertiser_Integration.md too? SignalCast optimizes for **Audience Relevance and Verified Conversions**.
